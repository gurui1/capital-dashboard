  ...
  <div class="wBox">
    <div class="bodyTop">
      ...
      <div class="search">
        <div class="top">
          ...
          <div class="four">
            <span>&nbsp;&nbsp;金额: &nbsp;&nbsp;&nbsp;</span>
            <el-input v-model="zhichu1" style="width: 6.4vw"> </el-input>
            &nbsp;一&nbsp;
            <el-input v-model="zhichu2" style="width: 6.4vw"> </el-input>

          </div>
          <!-- <div class="four"> -->
            <!-- <span>&nbsp;&nbsp;预计回款: &nbsp;&nbsp;&nbsp;</span>
            <el-input v-model="huikuan1" style="width: 6.4vw"> </el-input>
            &nbsp;一&nbsp;
            <el-input v-model="huikuan2" style="width: 6.4vw"> </el-input> -->
        ...
        <div class="bottom">
          <div class="three">
            ...
            <el-select v-model="yijiYW" clearable placeholder="请选择" style="width:  8vw">
          ...
          <div class="three">
            ...
            <el-select v-model="erjiYW" clearable placeholder="请选择" style="width:  8vw">
    ...
    <div class="bodyBottom">
      ...
      <el-table  :data="tableData" border class="table"
        ...
        <el-table-column align="center" prop="类型" label="类型" width="150" />
        <el-table-column align="center" prop="日期" label="日期" width="150" />
        <el-table-column align="center" prop="账户名称" label="账户名称" width="200" />
        <!-- <el-table-column align="center" prop="账户简称" label="账户简称" width="150" /> -->
        <el-table-column align="center" prop="部门" label="部门" width="200" />
        <el-table-column align="center" prop="归属BU" label="归属BU" width="150" />
        <el-table-column align="center" prop="一级业务" label="一级业务" width="150" />
        <el-table-column align="center" prop="二级业务" label="二级业务" width="150" />
        <el-table-column align="center" prop="金额" label="金额(人民币)" width="150" />
      ...
      <div class="last">
        ...
        <div class="lastone" style="position:relative;left: 880px;">{{ renminbi }}</div>
      </div>
...
import { biaoSeven,  } from "@/api/dataBoard/api";
import { exportExcel } from "../../excelConfig"
import { excelSeven } from "@/api/dataBoard/excel";
...
let toExcel = () => {
  let payLoad = reactive({
    ...
    startSzDate: timeLineVal.value[0],
    endSzDate: timeLineVal.value[1],
    startAmount: zhichu1.value,
    endAmount: zhichu2.value,
  ...
  .then((res) => {
      ...
      link.href = url;
      // // 设置下载的文件名，包括文件扩展名
      link.setAttribute('download', '系统外预计收支表.xlsx');
  ...
  // exportExcel('系统外预计收支表', tableData);
...
let getData = async () => {
  if (!timeLineVal.value) {
    ...
    timeLineVal.value= ['2024-06-01','2030-01-01'];
  }
  ...
  try {
    const response = await biaoSeven(payLoad);
    const resArr = response.data.data.pageInfo.list;
    tableData.splice(0, tableData.length);
    // console.log(resArr, 'resArr');
    // 清空原有数据
    resArr.forEach((item: { status: number; applyType: any; szDate: any; accountName: any; orgName: any; belongBu: any; firstBusiness: any; secondBusiness: any; amount: any; remarks: any; }) => {
      let statusText = '';
      if (item.status === 0) {
        statusText = '已支出';
...
.fenye {
  ...
  justify-content: flex-start; /* 内容在主轴上向右对齐 */
  align-items: center; /* 内容在交叉轴上居中对齐 */
  position: relative; /* 或者使用sticky/fixed定位，取决于需求 */
  width: 98%; /* 占据父元素的全部宽度 */
