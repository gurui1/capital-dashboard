  ...
  <div class="wBox">
    ...
    <div class="bodyBottom">
      ...
      <el-table-column align="center" prop="日期" label="日期" width="200" />
        ...
        <el-table-column align="center" prop="预计回款金额" label="预计回款金额(人民币)" />
      </el-table>
      <div class="last">
...
import { biaoFour,  } from "@/api/dataBoard/api";
import { exportExcel } from "../../excelConfig"
import { excelFour } from "@/api/dataBoard/excel"; 
...
let getData =async () => {
  ...
  try {
    const response = await biaoFour(payLoad);
