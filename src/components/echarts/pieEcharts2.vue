...
import { biao2 } from "@/api/dataBoard/data";
...
let getData = () => {
    ...
    biao2().then((res) => {
        ...
        resArr.forEach((item: { accountName: any; terminalBalance: any; percent: any; }) => {
            datas.push({
                value: item.terminalBalance,
